...
function renderPage(menus, data) {
    ...
    while (i < len) {
        ...
        html += '<div role="section" class="dashboard-section"><div role="sectionhead"><h1>Squash TEST</h1><h1 id="' + menuid + '" role="heading">' + menus[menu].icon + ' ' + menus[menu].title + '</h1></div><div role="section"  class="dashboard-subsection">';
